...
INSERT INTO customers (customer_id, customer_name, customer_segment, created_at) OVERRIDING SYSTEM VALUE
SELECT
...
INSERT INTO orders (order_id, customer_id, order_date, status, total_amount) OVERRIDING SYSTEM VALUE
SELECT
...
INSERT INTO order_items (order_item_id, order_id, product_id, quantity, unit_price) OVERRIDING SYSTEM VALUE
SELECT
